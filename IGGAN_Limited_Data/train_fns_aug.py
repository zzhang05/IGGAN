...
from DiffAugment_pytorch import rand_translation
    ...
    def train(x, y):
        ...
        for step_index in range(config['num_D_steps']):
            ...
            for accumulation_index in range(config['num_D_accumulations']):
                ...
                D1_fake, D1_real, D1_real_fake = GD1(z_[:config['batch_size']], y_[:config['batch_size']], x[counter], stitch(x[counter], k = 2),
                ...
                if config['curriculum_baseline'] and state_dict['epoch'] <= config['curriculum_epochs']:
                    ...
                    D_loss = (D1_loss_real + config['alpha'] * D1_loss_fake + config['beta']*D1_loss_real_fake + D2_loss_real + D2_loss_fake) / \
        ...
        for accumulation_index in range(config['num_G_accumulations']):
            ...
            if not config['conditional']:
                y_.zero_()
            D_fake = GD1(z_, y_, train_G=True, split_D=config['split_D']) + GD2(z_, y_, train_G=True, split_D=config['split_D'])
